              ...
              @click="showFood(food)">
                ...
                <div class="content">
                  ...
                  <div class="price">
                    ...
                    <span class="old" v-if="food.oldPrice">￥旧价{{food.oldPrice}}</span>
                  </div>
...
export default {
  data(){
    return{
      ...
      tops:[],//所有右侧分类li的top组成的数组，列表第一次显示后就不再发生变化
      food:{},//需要显示的Food中的food
    }
  },
  components:{
    CartControl,
  ...
  computed:{
    ...mapState(['goods']),
    // currentIndex()计算得到当前下标的分类
    currentIndex(){//初始和相关数据发生了变化
      // 得到条件数据
      const {scrollY,tops} = this
      // 根据条件计算产生一个结果
      const index = tops.findIndex((top,index)=>{
        // scrollY 大于等于当前top 且 小于下一个top
