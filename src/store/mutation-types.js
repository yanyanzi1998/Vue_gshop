...
export const RECEIVE_RATINGS = 'receive_ratings'//接收商品数组
export const RECEIVE_INFO = 'receive_info'//接收商品数组

export const INCREMENT_FOOD_COUNT = 'increment_food_count'//增加food的count值
export const DECREMENT_FOOD_COUNT = 'decrement_food_count'//减少food的count值

export const CLEAR_CART = 'clear_cart'//清空购物车

export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops'//结束搜索商家列表